...
var pwa_1 = __webpack_require__(19);
...
window.addEventListener('DOMContentLoaded', function () { return __awaiter(_this, void 0, void 0, function () {
    var db, PWA, clicker, saver, colorsManager, next, currentColor;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                db = new db_1.ColorsDb();
                return [4 /*yield*/, pwa_1.registerServiceWorker()];
            case 1:
                PWA = _a.sent();
                clicker = document.querySelector('.clicker');
                saver = document.querySelector('.buttons .save');
                colorsManager = new colors_1.ColorsManager(document.querySelector('body'), document.querySelector('.colors'));
                next = function () {
                ...
                next();
                return [4 /*yield*/, db.getAllColors()];
            case 2:
                (_a.sent()).map(function (colorDTO) {
...
var ColorsManager = /** @class */ (function () {
    function ColorsManager(backgroundEl, colorsListEl) {
        var _this = this;
        this.backgroundEl = backgroundEl;
        this.colorsListEl = colorsListEl;
        this.nextRandomColor = function () {
            var red = lodash_1.random(0, 255);
            var green = lodash_1.random(0, 255);
            var blue = lodash_1.random(0, 255);
            return [red, green, blue];
        };
        this.applyBgColor = function (color) {
            _this.backgroundEl.style.backgroundColor = "rgb(" + color[0] + ", " + color[1] + ", " + color[2] + ")";
        };
        this.displaySavedColor = function (color) {
            var el = document.createElement('div');
            el.className = 'color';
            el.style.backgroundColor = "rgb(" + color[0] + ", " + color[1] + ", " + color[2] + ")";
            _this.colorsListEl.appendChild(el);
        };
    }
    return ColorsManager;
}());
exports.ColorsManager = ColorsManager;
;
...
Object.defineProperty(exports, "__esModule", { value: true });
var dexie_1 = __webpack_require__(6);
;
var ColorsDb = /** @class */ (function (_super) {
    __extends(ColorsDb, _super);
    function ColorsDb() {
        var _this = _super.call(this, 'ColorsDB') || this;
    ...
    ColorsDb.prototype.saveColor = function (color) {
        return this.colors.add({
            color: color,
            synced: 0
        });
    };
    ColorsDb.prototype.markSynced = function (color) {
        return this.colors.put(__assign({}, color, { synced: 1 }));
    };
    ColorsDb.prototype.getAllColors = function () {
        return this.colors.toArray();
    };
    ColorsDb.prototype.getUnsyncedColors = function () {
...
var PWAService = /** @class */ (function () {
    function PWAService(serviceWorker) {
        this.sw = serviceWorker;
    }
    PWAService.prototype.sync = function () {
...
;
exports.registerServiceWorker = function () { return __awaiter(_this, void 0, void 0, function () {
    var registrastion;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0: return [4 /*yield*/, navigator.serviceWorker.register('./worker.js')];
            case 1:
                registrastion = _a.sent();
                return [2 /*return*/, new PWAService(registrastion)];
        }
    });
}); };
